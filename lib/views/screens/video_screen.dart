...
class VideoScreen extends StatelessWidget {
  ...
  buildProfile(String profilePhoto){
    return SizedBox(
      ...
      child: Stack(
        children: [
          Positioned(left: 5, child: Container(width: 50,height: 50,
  ...
  Widget build(BuildContext context) {
    ...
    children: [
          Expanded(child: Container(padding: const EdgeInsets.only(left:20), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.spaceEvenly,
    children: [
          Text(data.username,style: const TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),
    ),
    Text(data.caption,style: const TextStyle(fontSize: 20,color: Colors.white,
    ),
    ),
    Row(children: [
